...
#####FAKE
# Execute query
cursor.execute("SELECT videoname FROM metadata WHERE label = 'FAKE' LIMIT 100")
...
training_directory = 'Detection Algorithm/training/fake'
validation_directory = 'Detection Algorithm/validation/fake'
...
training_file_path = os.path.join(training_directory, 'fake.txt')
validation_file_path = os.path.join(validation_directory, 'fake.txt')
